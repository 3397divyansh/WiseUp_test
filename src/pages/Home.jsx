...
import CodeBlocks from "../Components/core/HomePage/CodeBlock.jsx";
    ...
    <div>
      <div className="mx-auto relative flex flex-col w-11/12 items-center justify-between text-white ">
        ...
        <div className="mx-3 my-12 shadow-blue-200 w-[70%] relative">
          <div className="grad2-top-100 w-[100px]"></div>
          <video className="video rounded-md" muted loop autoPlay>
      ...
      <div className="bg-pure-greys-5 text-richblack-700 ">
        ...
        <div
          className="mx-auto w-11/12 flex flex-col 
            max-w-maxContent justify-between gap-7 "
        >
